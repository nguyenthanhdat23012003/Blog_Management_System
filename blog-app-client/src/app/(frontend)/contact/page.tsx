      ...
      <div className="container mx-auto px-16">
        ...
        <div className="prose">
          <p>
            ...
            to hear from you! Use the form below to get in touch with the{" "}
            <span className="font-bold">Vie Insights</span> team.
          </p>
          ...
          <ul>
            ...
            <li>
              <span className="font-bold">Address:</span> 123 Tech Street,
              Silicon Valley, CA
            </li>
          </ul>
          <p>
            For general inquiries, please use the form below. We'll get back to
            you as soon as possible!
          </p>
        </div>
        <form
          className="bg-white shadow rounded-lg px-8 pt-6 pb-8 mb-4 max-w-lg mx-auto mt-20"
