...
import { useRouter, useParams } from "next/navigation"; // Use params to get dynamic seriesId
...
const EditSeriesPage = () => {
    ...
    const { id: seriesId } = useParams(); // Get seriesId from dynamic route
    ...
    return (
        <div className="rounded-xl flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="bg-white shadow-xl rounded-lg p-8 max-w-lg w-full">
                <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Edit Series</h2>
                {error && (
