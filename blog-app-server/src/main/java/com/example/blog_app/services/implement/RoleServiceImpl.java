...
public class RoleServiceImpl implements RoleService {
    ...
    public RoleDto updateRole(RoleDto roleDto, String roleName) {
        ...
        if(roleRepository.findByName(roleName).get().isImmutable()){
            throw new ImmutableResourceException("Can not modify ADMIN and USER role: " + roleDto.getName());
        }
    ...
    public void deleteRole(String roleName) {
        ...
        if(roleRepository.findByName(roleName).get().isImmutable()){
            throw new ImmutableResourceException("Can not remove ADMIN and USER role: " + roleName);
        }
